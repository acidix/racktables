...
function cloneLine (position) {
	...
	// Setup tagspicker
//	var newTagsPicker = $(".lineeditor-table > tbody > tr[count='" + parseInt(position + 1) + "'] >td.tagspicker-cell").html('<input class="ui-autocomplete-input tagspicker"/>')
//	setupTagsPicker(".lineeditor-table > tbody > tr[count='" + parseInt(position + 1) + "']");
