	...
	<div class=portlet>
		...
		<table border=0 align=center>
			...
			<tr>
				...
				<td class=tdleft><input type=text name=name value='<?php $this->Name; ?>'></td>
			</tr>
			<tr>
				<td>&nbsp;</td>
				<th class=tdright>Height (required):</th>
				<td class=tdleft><input type=text name=height value='<?php $this->Height; ?>'></td>
			</tr>
			<tr>
				<td>&nbsp;</td>
				<th class=tdright>Asset tag:</th>
				<td class=tdleft><input type=text name=asset_no value='<?php $this->AssetTag; ?>'></td>
			</tr>
