...
$this->setInMemoryTemplate("TabActive","<li class='tab active' id='{{Page}}{{Tab}}{{Args}}'><a class='tab-link' href='index.php?page={{Page}}&tab={{Tab}}{{Args}}' style='color:black;'>{{Title}}</a></li>");
...
$this->setInMemoryTemplate("TabInactive","<li class='tab inactive' id='{{Page}}{{Tab}}{{Args}}'><a class='tab-link' href='index.php?page={{Page}}&tab={{Tab}}{{Args}}'>{{Title}}</a></li>");
...
$this->setInMemoryTemplate("TabAttention","<li class='tab attention' id='{{Page}}{{Tab}}{{Args}}'><a class='tab-link' color:green href='index.php?page={{Page}}&tab={{Tab}}{{Args}}'>{{Title}}</a></li>");
...
/**
*	MakeIPAllocLink
*	Usage: makeIPAllocLink -> interface-lib.php
*
**/
$this->setInMemoryTemplate('MakeIPAllocLink', "<a href='{{Href}}' title='{{Title}}'>{{IsDisplayName}}{{ObjectName}}</a>");

/**
*	HrefToRow
*	Usage: renderRackspace -> interface-lib.php
*
**/
$this->setInMemoryTemplate('HrefToRow', "<a href='{{Href}}{{Cellfilter}}'>{{Row_Name}}</a>");

/**
*	CommentPortlet
*	Usage: renderRackInfoPortlet -> interface-lib.php
*
**/
$this->setInMemoryTemplate('CommentPortlet', "<div class=portlet><h2>{{Title}}</h2><div class=commentblock>{{Comment}}</div></div>");

/**
*	TripletConfigAJAX
*	Usage: getTripletConfigAJAX -> slb2-interface.php
*
**/
$this->setInMemoryTemplate('TripletConfigAJAX', "<div class='slbconf' style='max-height: 500px; max-width: 600px; overflow: auto'>{{SLB2_Config}}</div>");

/**
*	PatchCableEditor
*	Usage: renderPatchCableConnectorEditor, renderPatchCableTypeEditor ... -> interface.php
*
**/
$this->setInMemoryTemplate('PatchCableEditor', "<br>{{CableEditor}}<br>");
?>