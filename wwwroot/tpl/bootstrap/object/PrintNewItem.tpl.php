<?php if (defined("RS_TPL")) {?>
	...
	<tr><td>&nbsp;</td><th>Server</th><th>Graph</th><th>Caption</th><td>&nbsp;</td></tr>
	<?php 
	...
	<?php 
		$this->Getselect;
	?>
	</td><td><input type=text name=graph tabindex=100></td><td><input type=text name=caption tabindex=101></td><td>
	<?php 
