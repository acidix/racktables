...
END
	...
	<?php 
		if($this->is('Maxdecisions', TRUE)){
			?> <tr><th colspan=2>&nbsp;</th><th colspan=3>discard</th><th>&nbsp;</th></tr> <?php			
		}
	?>
	...
	<?php 
		if($this->is('Maxdecisions', TRUE)){
			...
			onclick="checkColumnOfRadios('i_', <?php $this->Maxdecision; ?>, '_<?php $this->Position; ?>')"></th> <?php
			$this->endLoop();
		}
	?>
	...
	<?php 
		if($this->is('Rownum_Set', TRUE)){
			?> <input type=hidden name=nrows value=<?php $this->Rownum; ?>> 
