		...
		<div class="box">
			...
			<div class="box-content">
				...
				<div class="row">
					...
					<div class="col-md-8">
						<button type="submit" class="btn btn-success ajax_form" targetform="#addFile" border="0" tabindex="102" title="Upload file"><span class="glyphicon glyphicon-ok"></span></button>	
					</div>
				</div>
				</form>
			</div>
