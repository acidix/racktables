<?php if (defined("RS_TPL")) {?>
	<rect x="<?php $this->X?>" y="<?php $this->Y ?>" width="192" height="<?php $this->Height; ?>" fill="none" stroke="black"/>
	<rect x="<?php echo ($this->_X + 5) ?>" y="<?php echo ($this->_Y + 5) ?>" width="182" height="<?php echo $this->_Height - 10; ?>" fill="#668aff" stroke="black"/>
