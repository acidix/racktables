...
function ip_format ($ip_bin)
{
    ...
    {
    case 4:
        return ip4_format ($ip_bin);
    case 16:
        return ip6_format ($ip_bin);
    default:
...
function ip_get_arpa ($ip_bin)
{
    ...
    {
    case 4:
        return ip4_get_arpa ($ip_bin);
    case 16:
        return ip6_get_arpa ($ip_bin);
    default:
        throw new InvalidArgException ('ip_bin', $ip_bin, "Invalid binary IP");
    }
}
...
function timestampFromDatetimestr ($s)
{
    ...
    if (FALSE === $tmp = strptime ($s, $format))
        throw new InvalidArgException ('s', $s, "not a date in format '$
                                       {
                                       format
                                   }'");
    return mktime
